...
class music_cog(commands.Cog):
    ...
    @commands.command(name="resume", aliases=["r"], help="Resumes the current paused song")
    ...
    @commands.command(name="queue", aliases=["q"], help="Displays the list of all songs in queue")
    ...
    @commands.command(name="leave", aliases=["disconnect", "l"], help="Clears the queue and disconnects from vc")
